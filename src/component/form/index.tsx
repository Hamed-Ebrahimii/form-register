...
const Form = () => {
  ...
  const {
    ...
    formState: { errors },
    handleSubmit,
  } = useForm<profileFormValidationType>({
    mode: "all",
  ...
  return (
    <form
      className=" w-full rounded-xl px-8 py-12 "
      onSubmit={handleSubmit(onSubmit)}
    >
      <section className="w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5 mt-6">
        <Controller
          name="name"
          control={control}
          render={({ field }) => (
        ...
        <Controller
          ...
          render={({ field }) => (
            <DropDown
              ...
              placeholder="وضیعت نظام وظیفه خود را انتخاب کنید"
              requier
              name="militaryService"
        ...
        />
        <div className="col-span-2 md:col-start-3 row-start-2">
            ...
            <Controller
              ...
              render={({ field }) => (
                <textarea
                  ...
                  rows={3}
                  maxLength={1000}
                  className={`border w-full max-h-20 bg-gray-100 ${
                    errors.address?.message
                      ? "border-red-500"
                      : "border-gray-200"
                  } rounded-md py-1 px-5 outline-none placeholder:text-gray-400 text-gray-500 placeholder:text-xs placeholder:font-semibold`}
                />
              )}
            />
            {errors.address?.message && (
      ...
      <section className="w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5 mt-6 items-start">
        <Controller
          control={control}
          name="placeOfBirth"
          render={({ field }) => (
            <DropDown
              ...
              placeholder="محل تولد خود را انتخاب کنید"
