...
export const profileFormValidation = z.object({
    ...
    nationalCode : z.string({required_error : 'کد ملی نمیتواند خالی باشد'}).min(11 , 'کد ملی باید 11 رقم باشد').max(11 , 'کد ملی نمیتواند بیشتر از 11 رقم باشد'),
    ...
    BirthCertificatePhoto : z.instanceof(File).refine(file => file.type !== 'jpeg' , 'لطفا  عکس را آپلود کنید'),
