...
export const profileFormValidation = z.object({
  name: z
    ...
    .min(2, "نام شما باید حداقل دو حرف باشد").max(15 , 'نام وارد شده نمیتواند بیشتر از پانزده حرف باشد' ),
  family: z
    .string({ required_error: "نام خانوادگی نمیتواند خالی باشد" })
    .min(4, "نام خانوادگی شما باید حداقل چهار حرف باشد").max(20 , 'نام خانوادگی وارد شده نمیتواند بیشتر از بیست حرف باشد' ),
  dateOfBirth: z
